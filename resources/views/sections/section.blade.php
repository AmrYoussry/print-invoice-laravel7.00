...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الإعــدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الأقسام</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									...
									<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">إنشاء قسم جديد</a>
									</div>
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-10p border-bottom-0">اسم القسم</th>
										...
										@foreach($sec as $z)
										 ...
										 <tr>
											<td>{{$i}}</td>
											<td>{{$z->section_name}}</td>
											<td>{{$z->description}}</td>
											<td>

                                              <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $z->id }}" data-section_name="{{ $z->section_name }}"
                                                data-description="{{ $z->description }}" data-toggle="modal"
				...
				<div class="modal-body">
					<form action ="{{route('section.store')}}" method="post" autocomplete="off">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="section_name" name="section_name"placeholder="إسم القسم" required>
						</div>
						<div class="mb-3">
